...
strings["Contents"]                              ="محتوا";
strings["Index"]                                 ="عناوین";
strings["Search"]                                ="جستجو";
strings["Bookmark"]                              ="نشانه";

strings["Loading the data for search..."]        ="بارگزاری نتیج جستجو";
strings["Type in the word(s) to search for:"]    ="عبارت مورد نظر را پیدا کن";
strings["Search title only"]                     ="فقط جستجوی عناوین";
strings["Search previous results"]               ="جستجوی نتایج قبلی";
strings["Display"]                               ="نمایش";
strings["No topics found!"]                      ="مقاله ای یافت نشد";

strings["Type in the keyword to find:"]          ="عبارت مورد نظر را پیدا کن";

strings["Show all"]                              ="نمایش";
strings["Hide all"]                              ="مخفی";
strings["Previous"]                              ="قبلی";
strings["Next"]                                  ="بعدی";

strings["Loading table of contents..."]          ="بارگزاری فهرست عناوین";

strings["Topics:"]                               ="مقالات";
strings["Current topic:"]                        ="مقاله فعلی";
strings["Remove"]                                ="حذف";
strings["Add"]                                   ="افزودن";
